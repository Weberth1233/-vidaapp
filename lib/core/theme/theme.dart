...
class AppTheme {
  ...
  static const Color _lightPrimaryColor = Color(0XFFDB3541);
  ...
  static final TextStyle _lightHeading1Text = GoogleFonts.sen(
    textStyle: const TextStyle(
        color: _lightTextColorVariantBlack, letterSpacing: .5, fontSize: 48),
  );

  static final TextStyle _lightHeading2Text = GoogleFonts.sen(
    textStyle: const TextStyle(
        color: _lightTextColorVariantBlack, letterSpacing: .5, fontSize: 40),
  );

  static final TextStyle _lightHeading3Text = GoogleFonts.sen(
    textStyle: const TextStyle(
        color: _lightTextColorVariantBlack, letterSpacing: .5, fontSize: 33),
  );

  static final TextStyle _lightHeading4Text = GoogleFonts.sen(
    textStyle: const TextStyle(
        color: _lightTextColorVariantBlack, letterSpacing: .5, fontSize: 28),
  );

  static final TextStyle _lightHeading5Text = GoogleFonts.sen(
    textStyle: const TextStyle(
        color: _lightTextColorVariantBlack, letterSpacing: .5, fontSize: 23),
  );

  static final TextStyle _lightParagraphText = GoogleFonts.sen(
    textStyle: const TextStyle(
        color: _lightTextColorVariantBlack, letterSpacing: .5, fontSize: 16),
  );

  static final TextStyle _lightSmallText = GoogleFonts.sen(
    textStyle: const TextStyle(
  ...
  static final ThemeData lightTheme = ThemeData(
      ...
      appBarTheme: const AppBarTheme(
          color: _lightTextColorVariantWhite,
          iconTheme: IconThemeData(color: _iconColor)),
      // bottomAppBarColor: _appbarColorLight,
      colorScheme: const ColorScheme.light(
        background: _lightPrimaryBackgroundColor,
